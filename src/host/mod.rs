...
pub trait Hci<E> {
    ...
    /// generated.
    async fn set_event_mask(&mut self, mask: EventFlags) -> Result<(), E>;
    ...
    /// event is generated.
    async fn read_local_version_information(&mut self) -> Result<(), E>;
    ...
    /// event is generated.
    async fn read_local_supported_commands(&mut self) -> Result<(), E>;
    ...
    /// event is generated.
    async fn read_local_supported_features(&mut self) -> Result<(), E>;
    ...
    /// generated.
    async fn read_bd_addr(&mut self) -> Result<(), E>;
    ...
    async fn read_rssi(&mut self, conn_handle: ConnectionHandle) -> Result<(), E>;
    ...
    /// generated.
    async fn le_set_event_mask(&mut self, event_mask: LeEventFlags) -> Result<(), E>;
    ...
    /// generated.
    async fn le_read_buffer_size(&mut self) -> Result<(), E>;
    ...
    /// event is generated.
    async fn le_read_local_supported_features(&mut self) -> Result<(), E>;
    ...
    async fn le_set_advertising_data(&mut self, data: &[u8]) -> Result<(), Error<E, Self::VS>>;
    ...
    /// is generated.
    async fn le_set_scan_response_data(&mut self, data: &[u8]) -> Result<(), Error<E, Self::VS>>;
    ...
    async fn le_set_advertise_enable(&mut self, enable: bool) -> Result<(), E>;
    ...
    async fn le_set_advertising_enable(&mut self, enable: bool) -> Result<(), E>;
    ...
    /// event.
    async fn le_set_scan_enable(&mut self, enable: bool, filter_duplicates: bool) -> Result<(), E>;
    ...
    /// been completed.
    async fn le_create_connection(&mut self, params: &ConnectionParameters) -> Result<(), E>;
    ...
    async fn le_create_connection_cancel(&mut self) -> Result<(), E>;
    ...
    /// generated.
    async fn le_read_white_list_size(&mut self) -> Result<(), E>;
    ...
    /// generated.
    async fn le_clear_white_list(&mut self) -> Result<(), E>;
    ...
    async fn le_add_device_to_white_list(&mut self, addr: crate::BdAddrType) -> Result<(), E>;
    ...
    /// space available, it shall return [`OutOfMemory`](Status::OutOfMemory).
    #[cfg(feature = "version-5-0")]
    async fn le_add_anon_advertising_devices_to_white_list(&mut self) -> Result<(), E>;
    ...
    /// event is generated.
    #[cfg(feature = "version-5-0")]
    async fn le_remove_anon_advertising_devices_from_white_list(&mut self) -> Result<(), E>;
    ...
    async fn le_encrypt(&mut self, params: &AesParameters) -> Result<(), E>;
    ...
    async fn le_rand(&mut self) -> Result<(), E>;
    ...
    async fn le_start_encryption(&mut self, params: &EncryptionParameters) -> Result<(), E>;
    ...
    /// is generated.
    async fn le_read_supported_states(&mut self) -> Result<(), E>;
    ...
    /// generated.
    async fn le_receiver_test(&mut self, channel: u8) -> Result<(), Error<E, Self::VS>>;
    ...
    Header: HciHeader,
{
    ...
    async fn read_remote_version_information(
        ...
        write_command::<Header, T, E>(self, crate::opcode::READ_REMOTE_VERSION_INFO, &params).await
    }
    ...
    async fn set_event_mask(&mut self, mask: EventFlags) -> Result<(), E> {
        ...
        write_command::<Header, T, E>(self, crate::opcode::SET_EVENT_MASK, &params).await
    }

    async fn reset(&mut self) -> Result<(), E> {
        write_command::<Header, T, E>(self, crate::opcode::RESET, &[]).await
    }
    ...
    async fn read_tx_power_level(
        ...
        write_command::<Header, T, E>(self, crate::opcode::READ_TX_POWER_LEVEL, &params).await
    }

    async fn read_local_version_information(&mut self) -> Result<(), E> {
        write_command::<Header, T, E>(self, crate::opcode::READ_LOCAL_VERSION_INFO, &[]).await
    }

    async fn read_local_supported_commands(&mut self) -> Result<(), E> {
        write_command::<Header, T, E>(self, crate::opcode::READ_LOCAL_SUPPORTED_COMMANDS, &[]).await
    }

    async fn read_local_supported_features(&mut self) -> Result<(), E> {
        write_command::<Header, T, E>(self, crate::opcode::READ_LOCAL_SUPPORTED_FEATURES, &[]).await
    }

    async fn read_bd_addr(&mut self) -> Result<(), E> {
        write_command::<Header, T, E>(self, crate::opcode::READ_BD_ADDR, &[]).await
    }

    async fn read_rssi(&mut self, conn_handle: ConnectionHandle) -> Result<(), E> {
        let mut params = [0; 2];
        LittleEndian::write_u16(&mut params, conn_handle.0);
        write_command::<Header, T, E>(self, crate::opcode::READ_RSSI, &params).await
    }
    ...
    async fn le_set_event_mask(&mut self, event_mask: LeEventFlags) -> Result<(), E> {
        ...
        write_command::<Header, T, E>(self, crate::opcode::LE_SET_EVENT_MASK, &params).await
    }

    async fn le_read_buffer_size(&mut self) -> Result<(), E> {
        write_command::<Header, T, E>(self, crate::opcode::LE_READ_BUFFER_SIZE, &[]).await
    }
    ...
    async fn le_set_scan_parameters(&mut self, params: &ScanParameters) -> Result<(), E> {
        let mut bytes = [0; 7];
        params.copy_into_slice(&mut bytes);
        write_command::<Header, T, E>(self, crate::opcode::LE_SET_SCAN_PARAMETERS, &bytes).await
    }
    ...
    async fn le_create_connection(&mut self, params: &ConnectionParameters) -> Result<(), E> {
        let mut bytes = [0; 25];
        params.copy_into_slice(&mut bytes);
        write_command::<Header, T, E>(self, crate::opcode::LE_CREATE_CONNECTION, &bytes).await
    }

    async fn le_create_connection_cancel(&mut self) -> Result<(), E> {
        write_command::<Header, T, E>(self, crate::opcode::LE_CREATE_CONNECTION_CANCEL, &[]).await
    }

    async fn le_read_white_list_size(&mut self) -> Result<(), E> {
        write_command::<Header, T, E>(self, crate::opcode::LE_READ_WHITE_LIST_SIZE, &[]).await
    }

    async fn le_clear_white_list(&mut self) -> Result<(), E> {
        write_command::<Header, T, E>(self, crate::opcode::LE_CLEAR_WHITE_LIST, &[]).await
    }
    ...
    async fn le_connection_update(&mut self, params: &ConnectionUpdateParameters) -> Result<(), E> {
        let mut bytes = [0; 14];
        params.copy_into_slice(&mut bytes);
        write_command::<Header, T, E>(self, crate::opcode::LE_CONNECTION_UPDATE, &bytes).await
    }
    ...
    async fn le_read_channel_map(&mut self, conn_handle: ConnectionHandle) -> Result<(), E> {
        ...
        write_command::<Header, T, E>(self, crate::opcode::LE_READ_CHANNEL_MAP, &bytes).await
    }
    ...
    async fn le_encrypt(&mut self, params: &AesParameters) -> Result<(), E> {
        ...
        write_command::<Header, T, E>(self, crate::opcode::LE_ENCRYPT, &bytes).await
    }

    async fn le_rand(&mut self) -> Result<(), E> {
        write_command::<Header, T, E>(self, crate::opcode::LE_RAND, &[]).await
    }
    ...
    async fn le_start_encryption(&mut self, params: &EncryptionParameters) -> Result<(), E> {
        ...
        write_command::<Header, T, E>(self, crate::opcode::LE_START_ENCRYPTION, &bytes).await
    }
    ...
    async fn le_long_term_key_request_reply(
        ...
        write_command::<Header, T, E>(self, crate::opcode::LE_LTK_REQUEST_REPLY, &bytes).await
    }
    ...
    async fn le_read_supported_states(&mut self) -> Result<(), E> {
        write_command::<Header, T, E>(self, crate::opcode::LE_READ_STATES, &[]).await
    }
    ...
    async fn le_test_end(&mut self) -> Result<(), E> {
        write_command::<Header, _, _>(self, crate::opcode::LE_TEST_END, &[]).await
    }
}
